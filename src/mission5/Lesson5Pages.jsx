...
function PatternOrbVisual(){return <span className="l5-page-one-illustration l5-page-one-pattern-orb" role="img" aria-label="Learned pattern orb"><i className="orb-core"><b/><b/><b/><b/></i><i className="orb-neck"/><i className="orb-base"/></span>}
...
function Page4ProbabilityBars({items,label}){return <div className="l5-page-four-probabilities" aria-label={label}>{items.map(([token,value],index)=><div className={`is-tone-${index+1}`} key={token}><span>{token}</span><i aria-hidden="true"><b style={{width:`${value}%`}}/></i><strong>{value}%</strong></div>)}</div>}
  ...
  return <section hidden={!active} className="l5-new-page l5-new-page-four"><LearningLayout sidebar={keyword}>
    <section className="l5-page-four-card">
      ...
      <div className="l5-page-four-flow">
        <section className="l5-page-four-stage is-before"><h3>{t("mission5.page4.beforeTitle")}</h3><p>{t("mission5.page4.beforeBody")}</p><Page4ProbabilityBars items={before} label={t("mission5.page4.beforeTitle")}/><div className="l5-page-four-note is-before-note"><CircleDot/><span>{t("mission5.page4.beforeNote")}</span></div></section>
        ...
        <ArrowRight className="l5-page-four-flow-arrow" aria-hidden="true"/>
        <section className="l5-page-four-stage is-after"><h3>{t("mission5.page4.afterTitle")}</h3><p>{t("mission5.page4.afterBody")}</p><Page4ProbabilityBars items={after} label={t("mission5.page4.afterTitle")}/><div className="l5-page-four-note is-after-note"><Check/><span>{t("mission5.page4.afterNote")}</span></div></section>
      </div>
