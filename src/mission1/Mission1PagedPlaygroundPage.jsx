...
export default function Mission1PagedPlaygroundPage({ active, language, t, exploreIndex, resetKey, onSuccessfulRun }) {
  return <section id="m1-playground-paged" className="course-section mission-1-paged__lesson mission-1-paged__playground-page" data-lesson-page="4" hidden={!active}>
    <div className="mission-paged-page-heading"><div className="course-section-head"><h2><span>4</span>{t("mission1.paged.experimentFlowLabel")}</h2></div><p>{t("mission1.liveTokenizerIntro")}</p><span className="mission-paged-heading-sticker" aria-hidden="true"><FlaskConical /><Sparkles /></span></div>
